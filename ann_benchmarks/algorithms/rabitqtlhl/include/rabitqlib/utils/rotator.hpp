...
#else
inline void rabitqlib_scalar_fht_float(float* buf, int log_n) {
    const int n = 1 << log_n;
...
inline void helper_float_6(float* buf) { rabitqlib_scalar_fht_float(buf, 6); }
inline void helper_float_7(float* buf) { rabitqlib_scalar_fht_float(buf, 7); }
inline void helper_float_8(float* buf) { rabitqlib_scalar_fht_float(buf, 8); }
inline void helper_float_9(float* buf) { rabitqlib_scalar_fht_float(buf, 9); }
inline void helper_float_10(float* buf) { rabitqlib_scalar_fht_float(buf, 10); }
inline void helper_float_11(float* buf) { rabitqlib_scalar_fht_float(buf, 11); }
#endif
...
class FhtKacRotator : public Rotator<float> {
   ...
   public:
    ...
    void rotate(const float* data, float* rotated_vec) const override {
        ...
        std::fill(rotated_vec + dim_, rotated_vec + padded_dim_, 0.0F);
